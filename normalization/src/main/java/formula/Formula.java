...
public class  Formula {
	...
	public Formula() {
		c_sig = new HashSet<>(); r_sig = new HashSet<>();
		subformulas = new ArrayList<>(); subformulae = new HashSet<>();
	}
	...
	public Formula clone() throws CloneNotSupportedException {
		...
		if (this == TopConcept.getInstance()) {
			...
			AtomicConcept c = new AtomicConcept(this.getText());
			if(this.neg) c.setNeg();
			return c;
